...
function goToViewBeforeAfter(key)
{		
	document.getElementById('viewBeforeAfterForm'+key).submit();
}
...
function goToViewSlideshowFromBeforeAfter(id,url2)
{	
	whatToView = 'slideshow.php?id='+id+'&url='+url2;
	parent.document.getElementById('whatToView').value = whatToView;
	parent.eval('$.prettyPhoto.close()');		
}

function goToViewGalleryFromBeforeAfter(id,url2)
{	
	whatToView = 'gallery.php?id='+id+'&url='+url2;
	parent.document.getElementById('whatToView').value = whatToView;
	parent.eval('$.prettyPhoto.close()');		
}
