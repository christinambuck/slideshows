...
<body id="photoManager"  <? if ($msg) { ?>  onLoad="$.prompt('<? echo $msg; ?>',{show:'show', top:'30%'})" <? } ?>>
    ...
    <?
		...
		if ($numImages) {
           ...
           <div class="photoManagerBox" id="mpdiv<? echo $key ?>" name="mpdiv" style=" <? if ($_POST['mpcurrent'] != 'mpdiv'.$key) echo 'display:none;'; ?>  ">
                ...
                <form action="managephotosajax.php" method="post" enctype="application/x-www-form-urlencoded" id="form<? echo $key ?>" name="form<? echo $key ?>">
	...
	<div id="photosToSort">
    	<form action="managephotosajax.php" method="post" enctype="application/x-www-form-urlencoded" id="mpform" name="mpform">
        ...
        <div id="instructions" >
            ...
            Drag photos to place them in the order your want them displayed and click Save Order when you are done.</p>
