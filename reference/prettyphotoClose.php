...
<body>
    <div id="page-wrap">
        ...
        <p style="text-align:center"><img src="images/example.jpg" width="518" height="294" alt="Example of pretty photo close button in top right" /></p>
        <ol>
            ...
            <img src="images/pp_close.jpg" width="556" height="196" alt="prettyphoto close button" /></li> 
            ...
            <img src="images/facebookDefault.jpg" width="819" height="219" alt="prettyphot facebook default theme" /><br />
            or added to the script<br />
            <img src="images/facebookTheme.jpg" width="706" height="172" alt="prettyphoto facebook theme in script " /></li>
            <li>I created a new close button to use <a href="images/close-button.png" title="prettyphoto close button" target="_blank" style="text-decoration:none"><img src="images/close-button.png" width="40" height="40" alt="prettyphoto close button" style="border-width:0px;" /></a>
            </li>
            ...
            <img src="images/newCloseButton.jpg" width="1096" height="51" alt="New prettyPhoto close button for top right" />
        </ol>
    </div>
</body>
</html>
