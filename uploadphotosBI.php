			...
			<? if ($slideshowId){ ?>
                ...
                <div id="divTop" name="divTop">
                    ...
                    <div id="uploadBox">                   
                            ...
                            <span style="color:#512112;font-size: 1.2em;line-height: 1.6em; font-weight:bold"> &nbsp;&nbsp;or Drag & Drop</span> 
                            <br>
                            <br>
                            ...
                            <br>                         
                            <!-- -->
                		<div id="continueUploadButton" class="customButton" alt="Organize Photos for Slideshow <? echo $slideshowId ?>" title="Organize photos" > 
                        <a href="<? echo 'http://'.$config['http_db_server'].$config['root'].'/editSlideshow.php?userName='.$_SESSION['userName']. '&slideshowId='.$slideshowId ?>" ><img class="buttonImg" src="images/edit2.png" > Continue</a></div>
                    </div> 
                        <div id="uploadTips">
                            ...
                            <ul>
                                ...
                                <li>If you are having problems uploading, you may try using the old upload page from <a href="uploadphotosOld.php">here</a>.</li>
