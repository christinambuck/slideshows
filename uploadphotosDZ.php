	...
	<div id="page-wrap"> 
			<? if ($slideshowId){ ?>
                ...
                <div id="divTop" name="divTop" style=" <? if (($_POST['upUpload'] || $_POST['upUpdate'])  && ($error != 1)) echo 'display:none;'; ?>">
                        ...
                        <form action="uploadsDZ.php" class="dropzone"></form>
                        <div id="uploadTips">
                ...
                <div id="divBottom" style=" <? if ((!$_POST['upUpload'] && !$_POST['upUpdate']) || ($_POST['numfiles'] == 0)) echo 'display:none;'; ?>">
                    <form action="uploadphotos.php" method="post" enctype="application/x-www-form-urlencoded" id="upForm2" name="upForm2">
