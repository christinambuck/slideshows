	...
	<div id="page-wrap"> 
			<? if ($slideshowId){ ?>
                ...
                <div id="divTop" name="divTop" style=" <? if (($_POST['upUpload'] || $_POST['upUpdate'])  && ($error != 1)) echo 'display:none;'; ?>">
        			<form id="upForm1" id="upForm1" action="uploadphotosOld.php" enctype="multipart/form-data" method="post"> 
                ...
                <div id="divBottom" style=" <? if ((!$_POST['upUpload'] && !$_POST['upUpdate']) || ($_POST['numfiles'] == 0)) echo 'display:none;'; ?>">
                    <form action="uploadphotosOld.php" method="post" enctype="application/x-www-form-urlencoded" id="upForm2" name="upForm2">
                        <input name="num" type="hidden" value="<? echo $num ?>" />
